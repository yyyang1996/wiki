...
plugins:
  - tooltip
intro: >
  The http status codes cheat sheet. a quick reference to every HTTP status
  code.
background: bg-pink-400
date: '2020-12-26T16:09:09.000Z'
...
* [1xx: Informational](http-status-code.md#1xx-information){data-tooltip="It means the request has been received and the process is continuing."}
* [2xx: Success](http-status-code.md#2xx-successful){data-tooltip="It means the action was successfully received, understood, and accepted."}
* [3xx: Redirection](http-status-code.md#3xx-redirection){data-tooltip="It means further action must be taken in order to complete the request."}
* [4xx: Client Error](http-status-code.md#4xx-client-error){data-tooltip="It means the request contains incorrect syntax or cannot be fulfilled."}
* [5xx: Server Error](http-status-code.md#5xx-server-error){data-tooltip="It means the server failed to fulfill an apparently valid request."}
